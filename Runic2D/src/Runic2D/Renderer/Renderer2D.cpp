...
namespace Runic2D
{
	...
	int Renderer2D::s_DrawCallCount = 0;
	...
	void Renderer2D::Init()
	{
		...
		uint32_t* quadIndices = new uint32_t[s_Data.MaxIndices]; //vigilar al utilitzar threadsque la info no es borri abans de pujarla a la GPU
